...
export function DiaryPage({ entries }: { entries: DiaryEntry[] }) {
				...
				<div className="flex flex-col gap-6 lg:w-[440px] lg:shrink-0">
					...
					<div className="rounded-xl border bg-card p-4">
						<textarea
							rows={4}
							placeholder="说点什么～"
							className="w-full resize-none rounded-lg border bg-transparent p-3 text-sm outline-none transition-colors focus:border-primary"
						/>
						<div className="mt-3 flex items-center justify-between">
							<div className="flex items-center gap-3">
								<input
									...
									placeholder="用户名"
									defaultValue="访客"
									className="h-9 w-32 rounded-lg border bg-transparent px-3 text-sm outline-none transition-colors focus:border-primary"
								/>
							...
							<button
								type="button"
								className="flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground opacity-50"
								disabled
							>
					...
					<div className="relative">
						...
						{selectedEntry ? (
								...
								<div className="mb-6">
									...
									<div className="mt-2 flex items-center gap-3">
										...
										<img
											alt="weather"
											className="size-5"
											src={getWeatherIcon(selectedEntry.weather)}
										/>
									</div>
								</div>

								{/* Content */}
								<div className="max-h-[840px] overflow-y-auto pr-2">
									<div className="prose prose-neutral dark:prose-invert text-sm leading-loose text-foreground/70">
							...
							<div className="relative flex items-center justify-center p-16">
								<p className="text-foreground/40">暂无随记内容</p>
							</div>
						)}
					</div>
				</div>
